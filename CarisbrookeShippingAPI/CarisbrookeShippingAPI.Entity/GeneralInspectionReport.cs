...
namespace CarisbrookeShippingAPI.Entity
{
    ...
    public partial class GeneralInspectionReport
    {
        public GeneralInspectionReport()
        {
            this.GIRPhotographs = new HashSet<GIRPhotograph>();
            this.GIRRestandWorkHours = new HashSet<GIRRestandWorkHour>();
            this.GlRCrewDocuments = new HashSet<GlRCrewDocument>();
            this.GlRSafeManningRequirements = new HashSet<GlRSafeManningRequirement>();
            this.GIRDeficiencies = new HashSet<GIRDeficiency>();
        }
        ...
        public Nullable<bool> IsPubsAndDocsSectionComplete { get; set; }
        public string CarriedOutByTheDOOW { get; set; }
        public Nullable<bool> IsRegs4shipsDVD { get; set; }
        public string Regs4shipsDVD { get; set; }
        public Nullable<bool> IsSOPEPPoints { get; set; }
        public string SOPEPPoints { get; set; }
        public Nullable<bool> IsBWMP { get; set; }
        public string BWMP { get; set; }
        public Nullable<bool> IsBWMPSupplement { get; set; }
        public string BWMPSupplement { get; set; }
        public Nullable<bool> IsIntactStabilityManual { get; set; }
        public string IntactStabilityManual { get; set; }
        public Nullable<bool> IsStabilityComputer { get; set; }
        public string StabilityComputer { get; set; }
        public Nullable<bool> IsDateOfLast { get; set; }
        public string DateOfLast { get; set; }
        public Nullable<bool> IsCargoSecuring { get; set; }
        public string CargoSecuring { get; set; }
        public Nullable<bool> IBulkCargo { get; set; }
        public string BulkCargo { get; set; }
        public Nullable<bool> IsSMSManual { get; set; }
        public string SMSManual { get; set; }
        public Nullable<bool> IsRegisterOf { get; set; }
        public string RegisterOf { get; set; }
        public Nullable<bool> IsFleetStandingOrder { get; set; }
        public string FleetStandingOrder { get; set; }
        public Nullable<bool> IsFleetMemoranda { get; set; }
        public string FleetMemoranda { get; set; }
        public Nullable<bool> IsShipsPlans { get; set; }
        public string ShipsPlans { get; set; }
        public Nullable<bool> IsCollective { get; set; }
        public string Collective { get; set; }
        public Nullable<bool> IsDraftAndFreeboardNotice { get; set; }
        public string DraftAndFreeboardNotice { get; set; }
        public Nullable<bool> IsPCSOPEP { get; set; }
        public string PCOPEP { get; set; }
        public Nullable<bool> INTVRP { get; set; }
        public string NTVRP { get; set; }
        public Nullable<bool> IVGP { get; set; }
        ...
        public Nullable<bool> IsGeneralSectionComplete { get; set; }
        public Nullable<bool> IsManningSectionComplete { get; set; }
        public Nullable<bool> IsShipCertificationSectionComplete { get; set; }
        public Nullable<bool> IsRecordKeepingSectionComplete { get; set; }
        public Nullable<bool> IsSafetyEquipmentSectionComplete { get; set; }
        public Nullable<bool> IsSecuritySectionComplete { get; set; }
        public Nullable<bool> IsBridgeSectionComplete { get; set; }
        public Nullable<bool> IsMedicalSectionComplete { get; set; }
        public Nullable<bool> IsGalleySectionComplete { get; set; }
        public Nullable<bool> IsEngineRoomSectionComplete { get; set; }
        public Nullable<bool> IsSuperstructureSectionComplete { get; set; }
        public Nullable<bool> IsDeckSectionComplete { get; set; }
        public Nullable<bool> IsHoldsAndCoverSectionComplete { get; set; }
        public Nullable<bool> IsForeCastleSectionComplete { get; set; }
        public Nullable<bool> IsHullSectionComplete { get; set; }
        public Nullable<bool> IsSummarySectionComplete { get; set; }
        public Nullable<bool> IsDeficienciesSectionComplete { get; set; }
        public Nullable<bool> IsPhotographsSectionComplete { get; set; }
        public int isDelete { get; set; }
    
        public virtual ICollection<GIRPhotograph> GIRPhotographs { get; set; }
        public virtual ICollection<GIRRestandWorkHour> GIRRestandWorkHours { get; set; }
        public virtual ICollection<GlRCrewDocument> GlRCrewDocuments { get; set; }
        public virtual ICollection<GlRSafeManningRequirement> GlRSafeManningRequirements { get; set; }
        public virtual ICollection<GIRDeficiency> GIRDeficiencies { get; set; }
    }
}
