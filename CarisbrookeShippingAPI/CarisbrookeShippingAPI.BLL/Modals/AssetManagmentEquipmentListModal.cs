...
namespace CarisbrookeShippingAPI.BLL.Modals
{
    ...
    public class AssetManagmentEquipmentLogModel
    {
        ...
        public string OTTableList { get; set; }
        public string ITTableList { get; set; }
        public string SoftwareAssetsList { get; set; }
    }
}
