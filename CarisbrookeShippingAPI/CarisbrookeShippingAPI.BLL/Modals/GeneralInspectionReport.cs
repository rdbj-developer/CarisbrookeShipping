...
namespace CarisbrookeShippingAPI.BLL.Modals
{
    ...
    {
        public List<Modals.DeficienciesNote> GIRDeficienciesComments { get; set; }
        public List<GIRDeficienciesInitialActions> GIRDeficienciesInitialActions { get; set; } //RDBJ 09/22/2021
        public List<GIRDeficienciesResolution> GIRDeficienciesResolution { get; set; } //RDBJ 09/22/2021
        ...
        public GIRDeficiencies()
        {
            ...
            //RDBJ 09/22/2021 commented below
            /*
            GIRDeficienciesComments = new List<DeficienciesNote>();
            GIRDeficienciesInitialActionModal = new List<GIRDeficienciesInitialActions>();
            GIRDeficienciesResolutionModal = new List<GIRDeficienciesResolution>();
            */
        }
        ...
        public bool IsSynced { get; set; }
        public Nullable<int> Priority { get; set; } //RDBJ 11/01/2021
        public Nullable<System.DateTime> DueDate { get; set; }   // RDBJ 02/28/2022
        public Nullable<System.Guid> AssignTo { get; set; } // RDBJ 12/17/2021
    }
