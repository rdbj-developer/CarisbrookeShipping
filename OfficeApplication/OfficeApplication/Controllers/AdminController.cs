...
namespace OfficeApplication.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public void AddFormFile(HttpPostedFileBase postedFiles, FormModal Modal)
        {
            ...
            if (postedFiles != null && postedFiles.ContentLength > 0)
            {
                ...
                FormModal dbModal = new FormModal()
                {
                    ...
                    CreatedDate = Utility.ToDateTimeUtcNow(), //DateTime.Now; //RDBJ 10/27/2021 set UtcTime
        ...
        public ActionResult GetCybersecurityRiskAssessmentList(string shipCode)
        {
            ...
            // JSL 01/12/2023
            ViewBag.LastReviwedDateTime = Modal.CybersecurityRisksAssessmentForm.UpdatedDate;
            // End JSL 01/12/2023
        ...
        #region Forms Person List
        public ActionResult FormsPerson()
        {
            return View();
        }
        #endregion
        ...
        public JsonResult PerformAction(string jsonmetadata, string straction)
        {
            ...
            if (!string.IsNullOrEmpty(jsonmetadata))
            {
                ...
                try
                {
                    dictToReturn = _helper.PostAsyncAPICall(APIURLHelper.APIUsers, "CommonPostAPICall", dictMetadata);
                }
                catch (Exception ex)
                {
