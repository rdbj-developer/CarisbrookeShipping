// RDBJ 01/07/2022 Added this script
var childrefe = true;
var active
var count
var isvalid = true;
...
var typeVal = "";
var i = 0;
var _UniqueFormID   // RDBJ 01/22/2022
    , _Ship // RDBJ 03/19/2022
    ; 

$(document).ready(function () {
    autosize(document.getElementsByTagName("textarea")); // RDBJ 01/20/2022

    //LoadGrid(); // RDBJ 01/08/2022 commented old codes
    $("#__ig_wm__").css("display", "none !important"); // RDBJ 01/08/2022 avoid trial version
    ...
    ValidateIAFForm();
    //addNewNotes(); // RDBJ 01/22/2022 // Commented 
    AuditTypeListSelection(); // RDBJ 01/08/2022
});
    ...
    if ($("#IAForm").valid()) {
        if (i < $('.notes').length) {
            ...
            if (desc != "") {
                ...
                HideAndShowTreeListInReferenceModal(typeVal); // RDBJ 01/08/2022

                count = $(".Listsection2 .form2").length;
                var url = RootUrl + 'IAFList/Details?id=' + active + '&count=' + count;
