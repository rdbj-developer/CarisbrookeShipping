...
$(document).ready(function () {
    ...
    $(".leftContent").height(height - 65);  // RDBJ 02/19/2022
    $(".rightContent").height(height - 65); // RDBJ 02/19/2022
    ...
    jQuery(document).on('click focus', '.SectionDiv textarea', function (e) {  // RDBJ 01/20/2022 change input[type=text] to textarea
        $('[data-toggle=popover]').popover('hide');    // RDBJ 02/18/2022
        ...
        if (no != undefined && no != null) {
            $('.notetable > tbody  > tr')
                ...
                //var td = $(tr).find("td:eq(1)").find("textarea").val(); // RDBJ 04/02/2022 commented this line
                if (no == td) {
        ...
        if (isNoteAvailable) {
            ...
            //$(this).parent().next().html('<i id="idAddNote" data-toggle="tooltip" data-placement="left" data-original-title="Add a Note/Corrective" class="material-icons" onclick="addNote(this)">note_add</i>')   // RDBJ 02/18/2022 commented this line
...
function bindContextMenuSIR() {
    menuDeficiency = $("#menuSIR").kendoContextMenu({
