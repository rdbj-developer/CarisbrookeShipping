...
function AddFile(e) {
    ...
    if (isDisable == 'disabled') {
        ...
        var selectedLength = $(".fancytree-active").length;
        if (selectedLength < 1) {
            var docID = '00000000-0000-0000-0000-000000000000';
            var parentId = '00000000-0000-0000-0000-000000000000';
            $("#txtDocumentID").val(docID);
            $("#txtParentID").val(parentId);
            $("#txtPath").text("C:\\ProgramData\\Carisbrooke Shipping Ltd\\ISM Dashboard\\Repository\\Documents\\" + $("#optSectionType").val());
        }
        //if (selectedLength == 1) {
            $('#btnEdit').attr('disabled', true);
            $('#btnSubmit').attr('disabled', false);
