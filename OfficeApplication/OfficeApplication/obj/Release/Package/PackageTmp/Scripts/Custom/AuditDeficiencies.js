...
function BindShipFSTOAuditsGrid() {
    ...
    var grid = $('#fstoGrid').kendoGrid({
        ...
        columns: [
            ...
            {
                template: '<input onclick="updateAdditionalAndCloseStatus(this, true)" type="checkbox" #= Extra ? \'checked="checked"\' : "" # class="chkbx" ' + blnIsVisitor + ' />',
                title: "Extra?",
                width: 60,
                attributes: { class: "mainContext" },
            },
            {
                ...
                title: "AuditDate",
                width: 100,
                template: "#= AuditDate!=null? kendo.toString(kendo.parseDate(AuditDate, 'yyyy-MM-dd'), 'dd-MMM-yyyy'):'' #",
                attributes: { class: "mainContext" },
            },
            {
                field: "Location",
            ...
            {
                template: '<input onclick="updateAdditionalAndCloseStatus(this, false)" type="checkbox" #= Closed ? \'checked="checked"\' : "" # class="chkbx" ' + blnIsVisitor + ' />', 
                title: "Closed?",
                width: 80,
                attributes: { class: "mainContext" },
            },
