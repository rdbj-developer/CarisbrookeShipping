var AddNewHelpAndSupportFormValidator = undefined; // RDBJ 12/28/2021

$(document).ready(function () {
    //autoRefresh(); // RDBJ 12/29/2021
    ValidateAddNewHelpAndSupportFormValidator(); // RDBJ 12/28/2021
    GetHelpAndSupportsList(); // RDBJ 12/28/2021
    SearchDataFromGrid(); // RDBJ 12/29/2021
});
        ...
        success: function (Data) {
            ...
            var grid = $('#HelpSupportsGrid').kendoGrid({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        title: "Ship",
                        width: "12%",
                        attributes: { class: "mainContext" }, // RDBJ 12/29/2021
                    },
                    {
                        field: "Comments",
                        title: "Comments",
            ...
            $("#context-menu").kendoContextMenu({
                ...
                select: function (e) {
                    ...
                    var ID = e.target.parentElement.children[0].textContent; // RDBJ 12/29/2021
                    var item = e.item.id; // RDBJ 12/29/2021
...
// RDBJ 12/29/2021 later use if needed
...
// End RDBJ 12/29/2021 later use if needed
