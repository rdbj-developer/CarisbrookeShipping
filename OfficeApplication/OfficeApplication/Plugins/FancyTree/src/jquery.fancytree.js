    ...
    Fancytree.prototype = /** @lends Fancytree# */{
        ...
        _makeHookContext: function (obj, originalEvent, extra) {
            ...
            if (obj.node !== undefined) {
                ...
                tree = obj.tree;
                ctx = {
                    node: obj, tree: tree, widget: tree.widget, options: tree.widget.options, originalEvent: originalEvent,
            ...
            */
            ...
            nodeRenderTitle: function (ctx, title) {
                ...
                if (!nodeTitle) {
                    ...
                    // }
                    var titleval;
                    if (node.data.number != null && node.data.number != undefined && node.data.number != "") {
                        titleval = node.data.number + " - " + node.title;
                    }
                    else {
                        titleval = node.title;
                    }
                    ...
                    nodeTitle = "<span class='fancytree-title'" +
                        tooltip + tabindex + ">" +
                        (opts.escapeTitles ? FT.escapeHtml(titleval) : titleval) +
                        "</span>";
                }
                ares.push(nodeTitle);
