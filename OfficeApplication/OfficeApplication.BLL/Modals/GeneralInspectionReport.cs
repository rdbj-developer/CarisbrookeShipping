...
namespace OfficeApplication.BLL.Modals
{
    public class GeneralInspectionReport
    {
        ...
        public CSShipsModal CSShipsModal { get; set; } //RDBJ 10/07/2021
    ...
    public class GIRDeficiencies
    {
        ...
        public Nullable<System.Guid> DeficienciesUniqueID { get; set; } //RDBJ 09/18/2021
        ...
        public List<GIRDeficienciesInitialActions> GIRDeficienciesInitialActions { get; set; } // RDBJ 02/18/2022
    }
    ...
    {
        public System.Guid? DeficienciesUniqueID { get; set; } //RDBJ 11/02/2021
