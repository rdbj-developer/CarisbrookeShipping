...
namespace OfficeApplication.BLL.Helpers
{
    public static class Utility
    {
        ...
        public static string GenerateBasicOAuthToken(string strUserName = "", string strPassword = ""
            , Dictionary<string, string> dictQueryString = null // JSL 09/27/2022
            )
        {
            string strOAuthToken = string.Empty;

            strUserName = SessionManager.Email;
            strPassword = SessionManager.Password;
            ...
            if (string.IsNullOrEmpty(strUserName) || string.IsNullOrEmpty(strPassword))
            {
                ...
                {
                    strUserName = dictQueryString["Email"];
                    strPassword = dictQueryString["Password"];
                }
            }
            // End JSL 09/27/2022
