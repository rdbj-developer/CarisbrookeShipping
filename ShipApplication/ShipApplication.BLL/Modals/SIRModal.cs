...
namespace ShipApplication.BLL.Modals
{
    ...
    { 
        ...
        public long OfficeSIRFormID { get; set; }
    ...
    public class SIRModal
    {
        ...
        public SIRModal() {
            SuperintendedInspectionReport = new SuperintendedInspectionReport();
            SIRNote = new List<SIRNote>();
            SIRAdditionalNote = new List<SIRAdditionalNote>();
            GIRDeficiencies = new List<GIRDeficiencies>();
        }
        public List<GIRDeficiencies> GIRDeficiencies { get; set; }
    }
    public class SIRNote
    {
        ...
        public System.Guid UniqueFormID { get; set; }
        public System.Guid NotesUniqueID { get; set; }  // RDBJ 04/01/2022
    }
